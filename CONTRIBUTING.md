Contributing to Bitszcoin Core
============================

The Bitszcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bitszcoin-project/bitszcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Bitszcoin Core project, and is not to be
confused with overall Bitszcoin Network Protocol consensus changes.

Whether a pull request is merged into Bitszcoin Core rests with the project merge
...
Patches that change Bitszcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Bitszcoin consensus, it must have been
...
The project leader is the release manager for each Bitszcoin Core release.
