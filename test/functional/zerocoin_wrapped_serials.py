...
from fake_stake.base_test import Bitszcoin_FakeStakeTest

class zBITSZwrappedSerialsTest(Bitszcoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBITSZs..." % DENOM_TO_USE)
