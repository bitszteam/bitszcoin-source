...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Bitszcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Bitszcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bitszcoin features */
        {"bitszcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"bitszcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitszcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitszcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitszcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitszcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitszcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitszcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"bitszcoin", "startmasternode", &startmasternode, true, true, false},
        {"bitszcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitszcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitszcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitszcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitszcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitszcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitszcoin", "preparebudget", &preparebudget, true, true, false},
        {"bitszcoin", "submitbudget", &submitbudget, true, true, false},
        {"bitszcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitszcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitszcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitszcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitszcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitszcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitszcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitszcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"bitszcoin", "mnsync", &mnsync, true, true, false},
        {"bitszcoin", "spork", &spork, true, true, false},
        {"bitszcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbitszseed", &getzbitszseed, false, false, true},
        {"zerocoin", "setzbitszseed", &setzbitszseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbitsz", &searchdzbitsz, false, false, true},
        {"zerocoin", "dzbitszstate", &dzbitszstate, false, false, true},
...
{
    return "> bitszcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:34441/\n";
}
