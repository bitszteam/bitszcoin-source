...
/**
 * Bitszcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZbitszSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzbitszseed(const UniValue& params, bool fHelp);
extern UniValue getzbitszseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbitsz(const UniValue& params, bool fHelp);
extern UniValue dzbitszstate(const UniValue& params, bool fHelp);
