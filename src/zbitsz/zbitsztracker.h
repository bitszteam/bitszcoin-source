...
#ifndef Bitszcoin_ZBITSZTRACKER_H
#define Bitszcoin_ZBITSZTRACKER_H
...
public:
    CzBITSZTracker(std::string strWalletFile);
    ~CzBITSZTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBITSZWallet* zBITSZWallet = NULL);
...
#endif //Bitszcoin_ZBITSZTRACKER_H
