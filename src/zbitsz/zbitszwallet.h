...
#ifndef Bitszcoin_ZBITSZWALLET_H
#define Bitszcoin_ZBITSZWALLET_H
...
public:
    CzBITSZWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBITSZ(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBITSZ(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //Bitszcoin_ZBITSZWALLET_H
