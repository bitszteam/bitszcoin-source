...
/** Utility functions used by the Bitszcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Bitszcoin addresses in monospace font
...
// Parse "bitszcoin:" URI into recipient object, return true on successful parsing
