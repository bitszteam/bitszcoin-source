                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBITSZPathCustom = GetArg("-zbitszbackuppath", "");
    ...
    if(!strzBITSZPathCustom.empty()) {
        ui->wallet_customzbitszbackuppath->setText(QString::fromStdString(strzBITSZPathCustom));
        ui->wallet_customzbitszbackuppath_label->setVisible(true);
        ui->wallet_customzbitszbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBITSZPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Bitszcoin RPC console.") + "<br>" +
