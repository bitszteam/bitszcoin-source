...
/* Bitszcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Bitszcoin"
#define QAPP_ORG_DOMAIN "bitszcoin.org"
#define QAPP_APP_NAME_DEFAULT "Bitszcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Bitszcoin-Qt-testnet"
