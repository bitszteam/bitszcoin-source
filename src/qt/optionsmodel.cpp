...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::BITSZ);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeBitszcoinAmount"))
        SoftSetArg("-anonymizebitszcoinamount", settings.value("nAnonymizeBitszcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in bitszcoin.cpp during shotdown to also remove the window positions
