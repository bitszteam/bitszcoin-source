...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitszcoin Core"),
     ...
     * override -datadir in the bitszcoin.conf file in the default data directory
     * (to be consistent with bitszcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
