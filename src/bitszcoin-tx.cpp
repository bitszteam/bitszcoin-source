...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitszcoin Core bitszcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitszcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitszcoin transaction") + "\n" +
                               "  bitszcoin-tx [options] -create [commands]   " + _("Create hex-encoded bitszcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitszcoin transaction
