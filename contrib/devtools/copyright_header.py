...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Bitszcoin developers'
...
Arguments:
    <base_directory> - The base directory of a bitszcoin source code repository.
"""
