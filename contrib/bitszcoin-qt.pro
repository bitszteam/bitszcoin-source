...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bitszcoin-cli.cpp \
           src/bitszcoin-tx.cpp \
           src/bitszcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/bitszcoin.qrc src/qt/bitszcoin_locale.qrc

TRANSLATIONS += src/qt/locale/bitszcoin_bg.ts \
                src/qt/locale/bitszcoin_de.ts \
                src/qt/locale/bitszcoin_en.ts \
                src/qt/locale/bitszcoin_es.ts \
                src/qt/locale/bitszcoin_fi.ts \
                src/qt/locale/bitszcoin_fr.ts \
                src/qt/locale/bitszcoin_it.ts \
                src/qt/locale/bitszcoin_ja.ts \
                src/qt/locale/bitszcoin_pl.ts \
                src/qt/locale/bitszcoin_pt.ts \
                src/qt/locale/bitszcoin_ru.ts \
                src/qt/locale/bitszcoin_sk.ts \
                src/qt/locale/bitszcoin_sv.ts \
                src/qt/locale/bitszcoin_vi.ts \
                src/qt/locale/bitszcoin_zh_CN.ts \
                src/qt/locale/bitszcoin_zh_TW.ts
